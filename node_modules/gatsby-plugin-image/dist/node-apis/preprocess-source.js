        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    images = (0, parser_2.extractStaticImageProps)(ast, filename, function (prop, nodePath) {
                        var sourceLocation = nodePath.node.loc;
                        var start = sourceLocation.start, end = sourceLocation.end;
                        reporter.error({
                            id: "95314",
                            filePath: filename,
                            location: {
                            ...
                            context: {
                                prop: prop,
                                codeFrame: (0, code_frame_1.codeFrameColumns)(contents, sourceLocation, {
                                    linesAbove: 6,
                                    linesBelow: 6,
                                    highlightCode: true,
                                }),
