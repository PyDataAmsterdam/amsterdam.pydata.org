...
function writeImages(_a) {
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        var _this = this;
        return __generator(this, function (_b) {
            promises = __spreadArray([], __read(images.entries()), false).map(function (_a) { return __awaiter(_this, void 0, void 0, function () {
                var file, fullPath, createRemoteFileNode, err_1, createFileNode, e_2, cacheKey, imageRefs, cacheFilename;
                var _b;
                var _c = __read(_a, 2), hash = _c[0], _d = _c[1], src = _d.src, args = __rest(_d, ["src"]);
