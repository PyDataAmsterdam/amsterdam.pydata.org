...
export declare const restrictedActionsAvailableInAPI: {
    [x: string]: {
        ...
        createSlice: import("redux").ActionCreator<import("../types").ActionsUnion> | import("redux").ActionCreator<import("redux-thunk").ThunkAction<any, import("../types").IGatsbyState, any, import("../types").ActionsUnion>>;
        addRemoteFileAllowedUrl: import("redux").ActionCreator<import("../types").ActionsUnion> | import("redux").ActionCreator<import("redux-thunk").ThunkAction<any, import("../types").IGatsbyState, any, import("../types").ActionsUnion>>;
    };
};
